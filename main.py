...
# ✅ Bot Token
TOKEN = "8363627795:AAE4SJB9ybrjTAoUAfrdgpSWTxqbTeNEP2Y"
...
{card_lines}
<b>───────────────</b>
<b>Requested By</b> - @{username} [❄️ꜱɴᴏᴡ ᴄᴄ ɢᴇɴ]
"""
    return text
...
def start_handler(message):
    ...
    text = (
       "🤖 Bσƚ Sƚαƚυʂ: Aƈƚιʋҽ ✅\n\n"
        "ᴛᴏ ʀᴇᴄᴇɪᴠᴇ ᴜᴘᴅᴀᴛᴇꜱ, ᴘʟᴇᴀꜱᴇ ᴊᴏɪɴ ᴛʜᴇ ᴄʜᴀɴɴᴇʟ[HERE](https://t.me/snowshopz)\n\n"        
"𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬:\n"
"/gen - ɢᴇɴᴇʀᴀᴛᴇ 10 ᴄᴀʀᴅꜱ\n"
"/fake - ɢᴇɴᴇʀᴀᴛᴇ ꜰᴀᴋᴇ ᴀᴅᴅʀᴇꜱꜱ"
    )
...
def gen_handler(message):
    ...
    btn.add(InlineKeyboardButton("ʀᴇ-ɢᴇɴᴇʀᴀᴛᴇ ♻️", callback_data=f"again|{bin_input}"))
...
def fake_address_handler(message):
    ...
    if country_code not in supported:
        return bot.reply_to(message, "❌ ᴛʜɪꜱ ᴄᴏᴜɴᴛʀʏ ɪꜱ ɴᴏᴛ ꜱᴜᴘᴘᴏʀᴛᴇᴅ ᴏʀ ʏᴏᴜ ᴇɴᴛᴇʀᴇᴅ ᴀɴ ɪɴᴠᴀʟɪᴅ ᴄᴏᴅᴇ.", parse_mode="Markdown")
...
OWNER_ID = 2261226739  # 🛑   Telegram User ID 
